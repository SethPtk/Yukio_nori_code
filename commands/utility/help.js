    ...
    async execute(client, message, args) {
        try{
            ...
            .addFields(
                ...
                { name: `🎲: Gambling`, value: '`coin flip,` `slots,` `kla klok,` `card,` `pav,` `cup,`' },
                { name: `🎮: Game`, value: '`race,` `guess[Premium],` `bankrob[Premium],` `survival apocalypse[Premium],`' },
                { name: `${gif.Rutr_gif}: Dragon`, value: '`egg,` `fight,` `upgrade,` `item,` `holder item,`' },
                { name: `🌱: Animal`, value: '`hunt,` `inventory,` `lootbox,` `crate,` `sell,` `use,` `zoo,` `team,` `battle,` `weapon,` `dex,` `quest,` `reroll,`' },
                { name: `📱: Social`, value: '`level,` `avatar,` `profile,`' },
                { name: `🏢: Work`, value: '`work,` `apply,` `resign,` `job,`' },
                { name: `👨‍🌾: Farm`, value: '`teas,` `psa,` `rongjak,` `hang,` `boat[Premium],`' },
                { name: `${gif.pickage_gif}: Mining`, value: '`storage,` `mine,` `tool,` `box,` `transfer,` `break,` `trade,`' },
                { name: `⚙️: Utilitys`, value: '`ping,` `help,` `state,` `prefix,` `supporter,` `premium,` `ID,`' },
