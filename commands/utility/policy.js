...
module.exports = {
    ...
    async execute(client, message, args) {
        try{
            ...
            .setTitle('Yukio Privacy Policy')
            .setDescription(`Yukio Privacy Policy explains what information about you is collected, used and disclosed upon every interaction you make with the bot.By using Yukio Bot you comply with the policies provided here`)
            .addFields(
