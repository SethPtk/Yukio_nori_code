...
module.exports = {
    ...
    async execute(client, message, args) {
        try{
            ...
            }else if(!parseInt(amount)){ amount = 1; }

            if(amount > 40){
                amount = 40;
            }

            if(userData.gem['100'] <= 0 || amount > userData.gem['100']){ message.reply({ embeds: [SimpleEmbed(`**Now <@${user.id}>**, you do not own this item!`)] }); return; };
